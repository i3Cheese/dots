...
-- statusline style
default.statusline_style = default.icon_styles.arrow
...
default.mode = {
    ...
    left_sep = {
        ...
        {
            str = default.statusline_style.vi_mode_icon,
            hl = function()
                return {
...
default.current_line = {
    ...
    left_sep = {
        ...
        {
            str = default.statusline_style.position_icon,
            hl = {
...
M.setup = function(override_flag)
    ...
    -- right
    add_table(default.right, default.mode)
